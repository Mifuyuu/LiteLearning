            ...
            <div class="border-t border-[#dedee5] space-y-8 p-6 lg:p-8">
                ...
                <div>
                    <h2 class="text-xl font-bold text-[#101114] mb-6 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="h-6 w-6 text-(--ll-blue) mr-2 shrink-0">
                ...
                <div>
                    <h2 class="text-xl font-bold text-[#101114] mb-6 flex items-center">
                        <x-icon name="medal" class="h-6 w-6 text-(--ll-blue) mr-2 shrink-0" />
                        {{ 'ตราความสำเร็จ' }}
