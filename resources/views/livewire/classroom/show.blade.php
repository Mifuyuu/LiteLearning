    ...
    <section class="overflow-hidden rounded-xl border-3 border-[#dedee5] bg-white min-h-[calc(100vh-3rem)]">
            ...
            <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                <div class="min-w-0">
                    ...
                    <div class="mt-4 flex flex-wrap items-center gap-2 text-xs font-bold">
                        <span class="inline-flex items-center gap-1.5 rounded-lg bg-[rgba(37,99,235,0.12)] px-3 py-1.5 text-(--ll-blue)">
                    ...
                    @if($manager)
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            ...
                            <ul x-show="open" x-cloak
                                ...
                                <li>
                                    <a href="{{ route('assignment.create', $classroom) }}?type=material" wire:navigate @click="open = false" class="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium text-[#101114] hover:bg-[rgba(37,99,235,0.06)] hover:text-(--ll-blue)">
        ...
        <div class="border-t border-[#f2eff5] p-5">
            <div class="flex items-center justify-between gap-3">
                ...
                <a href="{{ route('classroom.stream', $classroom) }}" wire:navigate
                    class="text-sm font-bold text-(--ll-blue) hover:text-(--ll-blue-dark)">{{ 'ดูทั้งหมด' }}</a>
            </div>
            <div class="mt-4 space-y-3">
                @forelse($classroom->announcements->take(3) as $announcement)
                    <a href="{{ route('classroom.stream', $classroom) }}" wire:navigate
                        class="block rounded-[10px] border border-[#dedee5] px-3 py-3 transition hover:border-[rgba(37,99,235,0.3)] hover:bg-(--ll-blue-faint)">
