<div x-data>
    ...
    <template x-teleport="body">
        <div class="fixed inset-0 z-80 flex items-center justify-center">
            ...
            <div class="relative z-81 bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 animate__animated animate__fadeInUp animate__faster">
                ...
                <form wire:submit="join" class="p-6">
                    <p class="text-sm text-gray-500 mb-4">{{ __('Ask your teacher for the class code, then enter it here.') }}</p>
                    ...
                    <div class="flex justify-end gap-3 mt-6">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
                            ...
                            <span wire:loading wire:target="join"><i class="fas fa-spinner fa-spin mr-1"></i> {{ __('Joining...') }}</span>
                        </button>
                    </div>
                </form>
            </div>
