<div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 animate__animated animate__fadeInUp animate__faster">
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
                <h3 class="text-xl font-bold text-gray-900">Join Classroom</h3>
            ...
            <form wire:submit="join" class="p-6">
                <p class="text-sm text-gray-500 mb-4">Ask your teacher for the class code, then enter it here.</p>
                ...
                <div class="flex justify-end gap-3 mt-6">
                    <button type="button" wire:click="$set('showModal', false)" class="px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg">
                        Cancel
                    </button>
                    <button type="submit" class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
                        ...
                        <span wire:loading wire:target="join"><i class="fas fa-spinner fa-spin mr-1"></i> Joining...</span>
                    </button>
                </div>
            </form>
        </div>
