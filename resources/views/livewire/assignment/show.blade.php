        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-200">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="flex items-center gap-3 mt-1">
                                    ...
                                    <span class="text-xs text-gray-400">{{ $assignment->created_at->format('M j, Y') }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 flex items-center gap-4 text-sm">
                        <span class="text-gray-500">
                            <i class="fas fa-clock mr-1"></i> Due: {{ $assignment->due_date->format('M j, Y, g:i A') }}
                        </span>
                        @if($assignment->type !== 'material')
                        <span class="text-gray-500">
                            <i class="fas fa-star mr-1"></i> {{ $assignment->max_score }} points
                        </span>
                        @endif
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <h3 class="text-sm font-semibold text-gray-900 mb-2"><i class="fas fa-list-ul mr-1"></i> Instructions</h3>
            ...
            <div class="mt-6 bg-white rounded-xl border border-gray-200 overflow-hidden">
                <div class="p-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Student Work</h3>
                    <div class="flex gap-4 mt-2 text-sm text-gray-500">
                        <span><i class="fas fa-check-circle text-green-500 mr-1"></i> {{ $assignment->submittedCount() }} Turned in</span>
                        <span><i class="fas fa-star text-amber-500 mr-1"></i> {{ $assignment->gradedCount() }} Graded</span>
                        @if($assignment->averageScore())
                        <span><i class="fas fa-chart-line text-blue-500 mr-1"></i> Avg: {{ round($assignment->averageScore()) }}/{{ $assignment->max_score }}</span>
                        @endif
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    @if($sub->status === 'turned_in')
                                        <span class="text-blue-600">Turned in {{ $sub->turned_in_at?->diffForHumans() }}</span>
                                    @elseif($sub->status === 'graded')
                                        <span class="text-green-600">Graded: {{ $sub->score }}/{{ $assignment->max_score }}</span>
                                    @elseif($sub->status === 'returned')
                                        <span class="text-purple-600">Returned</span>
                                    @else
                                        <span class="text-gray-400">Not turned in</span>
                                    @endif
                                </p>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden sticky top-24">
                <div class="p-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900">Your Work</h3>
                        @if($userSubmission)
                        ...
                        @else
                            <span class="text-xs px-2.5 py-1 rounded-full font-medium bg-gray-100 text-gray-600">Assigned</span>
                        @endif
                    </div>
                ...
                <div class="p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <button wire:click="turnIn"
                            ...
                            <span wire:loading.remove wire:target="turnIn">Turn In</span>
                            <span wire:loading wire:target="turnIn"><i class="fas fa-spinner fa-spin mr-1"></i> Submitting...</span>
                        </button>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-700 font-medium">Turned in</p>
                        <p class="text-xs text-gray-500 mt-1">{{ $userSubmission->turned_in_at?->format('M j, g:i A') }}</p>
        ...
        <div>
            <div class="bg-white rounded-xl border border-gray-200 p-4 sticky top-24">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-gray-500">Turned in</span>
                ...
                <div class="text-center py-4">
                    ...
                    <p class="text-sm text-gray-500">This is a material - no submission required.</p>
                </div>
                @endif
            </div>
        </div>
