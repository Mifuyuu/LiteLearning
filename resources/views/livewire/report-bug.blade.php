        ...
        <div class="fixed inset-0 z-[70] flex items-center justify-center px-4" x-data
            ...
            <div
                ...
                <form wire:submit="submit" class="space-y-4">
                    ...
                    <div>
                        <label
                            class="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">{{ __('report.type_label') }}</label>
                        <div class="flex gap-2">
                            @foreach([
                                                'bug' => ['label' => __('report.type_bug'), 'icon' => 'fa-bug', 'color' => 'red'],
                                                'suggestion' => ['label' => __('report.type_suggestion'), 'icon' => 'fa-lightbulb', 'color' => 'amber'],
                                                'other' => ['label' => __('report.type_other'), 'icon' => 'fa-circle-question', 'color' => 'gray']
                                            ] as $val => $opt)
          ...
          g                 e --}}
                    ...
                    <div class="flex gap-2 pt-1">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="btn-3d btn-3d-
           -                        indigo flex-1 py-2.5 rounded-xl text-sm font-semibold transition cursor-pointer disabled:opacity-60">
