    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        <form wire:submit="login" class="space-y-5">
            ...
            <button type="submit"
                ...
                <span wire:loading wire:target="login"><i class="fas fa-spinner fa-spin mr-2"></i> {{ __('Signing in...') }}</span>
            </button>
        </form>
        ...
        <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <p class="text-xs font-semibold text-gray-500 uppercase mb-2">{{ __('Demo Accounts') }}</p>
            <div class="space-y-1 text-xs text-gray-600">
                <p><strong>{{ __('Teacher') }}:</strong> teacher@litelearning.com / password</p>
                <p><strong>{{ __('Student') }}:</strong> student@litelearning.com / password</p>
                <p><strong>{{ __('Admin') }}:</strong> admin@litelearning.com / password</p>
            </div>
        </div>
    </div>
</div>
