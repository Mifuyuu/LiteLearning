                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex justify-end gap-3 text-gray-400">
                                    ...
                                    <button type="button"
                                        @click="$dispatch('open-delete-badge', { id: {{ $badge->id }}, name: '{{ addslashes($badge->name) }}' })"
...
<div x-data="{ showDeleteModal: false, deleteId: null, deleteName: '' }"
    @open-delete-badge.window="deleteId = $event.detail.id; deleteName = $event.detail.name; showDeleteModal = true"
