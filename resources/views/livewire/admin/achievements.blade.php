                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex justify-end gap-3 text-gray-400">
                                    ...
                                    <button wire:click="delete({{ $achievement->id }})"
                                        wire:confirm="{{ __('admin.achievements.delete_confirm') }}"
            ...
            <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div class="flex items-end gap-4">
                    <div class="flex-1">
                        ...
                        <select wire:model="form.target_role" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                            <option value="">{{ __('admin.achievements.target_all') }}</option>
