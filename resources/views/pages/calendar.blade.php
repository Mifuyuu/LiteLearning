...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p class="text-gray-500 max-w-md mx-auto">View all your upcoming assignments and deadlines in one place.</p>
            ...
            <div class="mt-8 text-left">
                        ...
                        <a href="{{ route('assignment.show', ['classroom' => $a->classroom, 'assignment' => $a->id]) }}"
                           class="block p-3 bg-gray-50 rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xs text-gray-400">{{ $a->due_date->format('g:i A') }}</span>
                            </div>
                        </a>
                        @endforeach
                    </div>
                ...
                @empty
                <p class="text-center text-gray-400 py-4">No upcoming deadlines!</p>
                @endforelse
            </div>
        </div>
    </div>
